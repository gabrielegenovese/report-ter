...
% spiegare tabella
% in particolare le linee con tanti warning/errori/stati/edge
% spiegare con minimizzazione
% dire che l'algoritmo è efficente (empiricamente)
% sostituire il primo esempio con async
% fare riferimento alla tabella quando si nominano gli esemi
% fare tabella a parte per la correttezza